...
export function ImportContasReceberDialog({ open, onOpenChange, onSuccess }: Props) {
  ...
  async function handleImport() {
    ...
    try {
      ...
      toast.success(`${records.length} conta(s) a receber importada(s)`);
      setPreview([]);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription>Importe contas a receber via arquivo Excel (.xlsx)</DialogDescription>
        </DialogHeader>
